            ...
            <form onSubmit={submittobackend} method='POST' className="grid grid-cols-1 md:grid-cols-2 gap-6 rounded-lg mt-8">
              <div className="col-span-2 md:col-span-1">
                <div className="space-y-2 mt-6">
                  ...
                  <input type="text" id="fullName" name="fullname" value={data.fullname} onChange={handleInputChange} className="input-style" required />
                </div>
              </div>
              <div className="col-span-2 md:col-span-1">
                <div className="space-y-2 mt-6">
                  <label htmlFor="email" className="block text-black">Email:</label>
                  <input type="email" id="email" name="email" value={data.email} onChange={handleInputChange} className="input-style" required />
                </div>
              </div>
              <div className="col-span-2 md:col-span-1">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                    <input type={passwords ? "password" : "text"} id="password" name='password' value={data.password} onChange={handleInputChange} className="input-style" required />
              ...
              <div className="col-span-2 md:col-span-1">
                <div className="space-y-2">
                  ...
                  <div className="flex items-center">
                    <input type={passwordss ? 'password' : 'text'} id="password1" name='reenterpassword' value={data.reenterpassword} onChange={handleInputChange} className="input-style" required />
